...
async def word_live_format_text(
    ...
    """Format text in an open Word document: font, color, highlight, style, alignment, page breaks.
...
async def word_live_apply_list(
    ...
    """Apply or remove bullet/numbered/multilevel list formatting on paragraphs.
...
async def word_live_replace_text(
    ...
    """Find and replace text in an open Word document.
...
async def word_live_insert_paragraphs(
    ...
    """Insert one or more paragraphs near a target paragraph in an open Word document.
...
async def word_live_modify_table(
    ...
    """Modify a table in an open Word document.
...
async def word_live_undo(
    ...
    """Undo the last N operations in an open Word document.
